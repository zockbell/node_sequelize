  ...
  <div class="home">
    ...
    <!-- 关键词搜索 -->
      <i-form ref="formInline" :rules="ruleInline" inline>
        <Form-item prop="word">
            <i-input type="text" v-model="formInline.word" placeholder="请输入关键字"></i-input>
        </Form-item>
        <Form-item>
            <i-button type="primary" @click="handleKeyWord('formInline')">搜索</i-button>
        </Form-item>
        ...
        if (valid && this.formInline.word) {
          ...
          .then(res => {
            ...
            if(res.errcode == 110) {
              ...
              this.formInline.count = res.todo.count;
              this.data = res.todo.rows;
